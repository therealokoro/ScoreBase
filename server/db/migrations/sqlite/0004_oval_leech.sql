...
INSERT INTO `__new_subject_lists`("id", "name", "subjects", "createdAt", "updatedAt") SELECT "id", "name", "subjects", "createdAt", "updatedAt" FROM `subject_lists`;--> statement-breakpoint
